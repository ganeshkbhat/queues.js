...
var Queue = require("../index.js").QueueTopFifo;


describe('test-.mjs::queues.js: Test Suite for queues.js demos.queue.top.fifo.js Files', function () {

    it('test-.js::queues.js: [Test A] Test Suite for queues.js QueueTopFifo tests for add and remove', function (done) {
        let type = "front";
        let method = "fifo";
